...
@SpringBootTest
class SaosJudgmentSynopsisSearchResultTest {
    ...
    void shouldReturnMappedResult() {
        SaosJudgmentSynopsisSearchResult searchResult = new SaosJudgmentSynopsisSearchResult();

        try {
            searchResult = objectMapper.readValue(jsonResult, SaosJudgmentSynopsisSearchResult.class);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }

        SaosJudgmentSynopsisSearchResult finalSearchResult = searchResult;
        assertAll(
